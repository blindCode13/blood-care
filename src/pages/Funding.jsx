  ...
  if (isLoading) return <Loading />
    ...
    return (
        <div className='space-y-10'>
            <div className="bg-primary-bg shadow-lg rounded-3xl p-8 border border-gray-100/40 w-fit text-center mx-auto">
                ...
                <form className='flex items-center gap-3 mt-6' onSubmit={handleSubmit}>
                        <input
                            ...
                            className="w-full border border-gray-300/60 rounded-xl px-5 py-3 outline-none focus:border-primary focus:ring-1 focus:ring-primary"
                        />
...

            {
              ...
              <div className=' xl:block space-y-3'>
                <div className="grid grid-cols-4 gap-x-5 text-center px-4 py-3 text-sm text-primary-text/80 uppercase w-full">
                    <span>Sl no</span>
                ...
                <div
                  key={fund._id}
                  className="grid grid-cols-4 gap-x-5 items-center justify-items-center bg-primary-bg shadow-md rounded-xl px-4 py-5"
                >
